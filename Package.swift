...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "aa8dfc18b65edda846f73b994749b7ce7de4dfd4d5b649e2237b8c3fbc5e71ca"
        ),
        .binaryTarget(
            ...
            checksum: "2c19b121e338e167000652fdb75b336b4fdf376a2383e83a1686b979eb824edd"
        ),
        .binaryTarget(
            name: "VonageClientSDKVoice",
            url: "https://cs-sdk.main0.api.rtc.prd.euw1.vonagenetworks.net/public/2.6.1/ios/SPM-VonageClientSDKVoice-2.6.1-Release.zip",
            checksum: "6eaa32df1dfae110b2b2a5a75bf0c47291e2e0c86ff414ae1f7ce4fe185d933f"
        ),
        .binaryTarget(
            name: "VonageClientSDKEmergency",
